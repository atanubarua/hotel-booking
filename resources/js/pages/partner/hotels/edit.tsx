...
export default function PartnerHotelsEdit() {
    ...
    const form = useForm<HotelForm>({
        ...
        status: hotel.status,
        cancellation_deadline_hours: String((hotel as Record<string, unknown>).cancellation_deadline_hours ?? 48),
    ...
    function handleSubmit(e: React.FormEvent) {
        e.preventDefault();
        form.post(`/partner/hotels/${hotel.id}`, {
            forceFormData: true,
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm">Update your hotel details</p>
                    </div>
                </div>
